...
# Weld
graph.new_node((19,20),[12,14,17,21,30,33,34],"weld")

# University Hall
graph.new_node((18,26),[16,18,20,21,28,29,30,31,33,34],"university hall")

# Thayer
graph.new_node((22,37),[11,17,19,20,28,29,34],"thayer")

# Canaday
graph.new_node((30,40),[11,18,20,27],"canaday")

# Mem Church
graph.new_node((28,33),[17,18,19,28,32,34],"memorial church")

# Widener
graph.new_node((26,15),[14,15,16,22,25,31],"widener library")
...
# Emerson
graph.new_node((36,19),[21,24,26,31],"emerson")

# Sever
graph.new_node((34,26),[20,25,27,31,32],"sever")
...
graph.new_node((26,21),[16,21,25,26,32,33],"intersection31")
graph.new_node((27,26),[20,26,31,33],"intersection32")
graph.new_node((24,24),[16,17,31,32,34],"intersection33")
graph.new_node((23,27),[17,18,20,33],"intersection34")